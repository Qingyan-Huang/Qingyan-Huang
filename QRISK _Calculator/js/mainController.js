...
$(document).ready(function($) {
	...
	$('#buttonsearch').click(function(){
		...
		if (searchName == ''){
			...
			const url = "http://localhost:8082/openmrs-standalone/ws/rest/v1/patient?q="+searchName.val()+"&limit=10"
			...
			var requestOptions = {
  			...
  			fetch(url, requestOptions)
  				...
  				.then((data) => {
					...
					let url = "http://localhost:8082/openmrs-standalone/ws/rest/v1/person/"+uuid;
					...
					fetch(url, requestOptions)
						...
						sessionStorage.setItem("gender", jsonObj.gender);
